...
Tool = [eye(3),[0,0,100]';
        zeros(1,3),1];
robot_poe = my_poe_robot(Tool, true, 0.001, 0.05, true, 0.05,20, false,0.001,1);
%% Prepare real robot
...
%         norm(mean(Ts_true - Ts_nominal,3));
        [~, delta_poe] = kinematic_calibration_poe_absolute(robot_poe, angle_list,Ts_true, Ts_nominal, n_points, type);
